...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = aera_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=aera_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=aera_config.HUAWEI_OBS_SECRET_KEY,
            server=aera_config.HUAWEI_OBS_SERVER,
        )
