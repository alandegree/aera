...
class VolcengineTosStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = aera_config.VOLCENGINE_TOS_BUCKET_NAME
        self.client = tos.TosClientV2(
            ak=aera_config.VOLCENGINE_TOS_ACCESS_KEY,
            sk=aera_config.VOLCENGINE_TOS_SECRET_KEY,
            endpoint=aera_config.VOLCENGINE_TOS_ENDPOINT,
            region=aera_config.VOLCENGINE_TOS_REGION,
        )
