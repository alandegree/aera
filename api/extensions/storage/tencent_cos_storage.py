...
class TencentCosStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = aera_config.TENCENT_COS_BUCKET_NAME
        config = CosConfig(
            Region=aera_config.TENCENT_COS_REGION,
            SecretId=aera_config.TENCENT_COS_SECRET_ID,
            SecretKey=aera_config.TENCENT_COS_SECRET_KEY,
            Scheme=aera_config.TENCENT_COS_SCHEME,
        )
