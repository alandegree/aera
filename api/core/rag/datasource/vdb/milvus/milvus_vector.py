...
class MilvusVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            ...
            config=MilvusConfig(
                uri=aera_config.MILVUS_URI or "",
                token=aera_config.MILVUS_TOKEN or "",
                user=aera_config.MILVUS_USER or "",
                password=aera_config.MILVUS_PASSWORD or "",
                database=aera_config.MILVUS_DATABASE or "",
                enable_hybrid_search=aera_config.MILVUS_ENABLE_HYBRID_SEARCH or False,
            ),
        )
