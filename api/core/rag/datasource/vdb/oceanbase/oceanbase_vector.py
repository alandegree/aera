    ...
    def init_vector(
        ...
        return OceanBaseVector(
            ...
            OceanBaseVectorConfig(
                host=aera_config.OCEANBASE_VECTOR_HOST or "",
                port=aera_config.OCEANBASE_VECTOR_PORT or 0,
                user=aera_config.OCEANBASE_VECTOR_USER or "",
                password=(aera_config.OCEANBASE_VECTOR_PASSWORD or ""),
                database=aera_config.OCEANBASE_VECTOR_DATABASE or "",
            ),
        )
