...
class BaiduVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaiduVector:
        ...
        return BaiduVector(
            ...
            config=BaiduConfig(
                endpoint=aera_config.BAIDU_VECTOR_DB_ENDPOINT or "",
                connection_timeout_in_mills=aera_config.BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS,
                account=aera_config.BAIDU_VECTOR_DB_ACCOUNT or "",
                api_key=aera_config.BAIDU_VECTOR_DB_API_KEY or "",
                database=aera_config.BAIDU_VECTOR_DB_DATABASE or "",
                shard=aera_config.BAIDU_VECTOR_DB_SHARD,
                replicas=aera_config.BAIDU_VECTOR_DB_REPLICAS,
            ),
        )
