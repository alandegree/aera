    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TencentVector:
        ...
        return TencentVector(
            ...
            config=TencentConfig(
                url=aera_config.TENCENT_VECTOR_DB_URL or "",
                api_key=aera_config.TENCENT_VECTOR_DB_API_KEY,
                timeout=aera_config.TENCENT_VECTOR_DB_TIMEOUT,
                username=aera_config.TENCENT_VECTOR_DB_USERNAME,
                database=aera_config.TENCENT_VECTOR_DB_DATABASE,
                shard=aera_config.TENCENT_VECTOR_DB_SHARD,
                replicas=aera_config.TENCENT_VECTOR_DB_REPLICAS,
            ),
        )
