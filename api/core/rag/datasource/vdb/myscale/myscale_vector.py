    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=aera_config.MYSCALE_HOST,
                port=aera_config.MYSCALE_PORT,
                user=aera_config.MYSCALE_USER,
                password=aera_config.MYSCALE_PASSWORD,
                database=aera_config.MYSCALE_DATABASE,
                fts_params=aera_config.MYSCALE_FTS_PARAMS,
            ),
        )
