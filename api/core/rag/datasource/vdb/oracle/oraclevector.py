    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                user=aera_config.ORACLE_USER or "system",
                password=aera_config.ORACLE_PASSWORD or "oracle",
                dsn=aera_config.ORACLE_DSN or "oracle:1521/freepdb1",
                config_dir=aera_config.ORACLE_CONFIG_DIR,
                wallet_location=aera_config.ORACLE_WALLET_LOCATION,
                wallet_password=aera_config.ORACLE_WALLET_PASSWORD,
                is_autonomous=aera_config.ORACLE_IS_AUTONOMOUS,
            ),
        )
