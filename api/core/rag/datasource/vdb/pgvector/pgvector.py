    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=aera_config.PGVECTOR_HOST or "localhost",
                port=aera_config.PGVECTOR_PORT,
                user=aera_config.PGVECTOR_USER or "postgres",
                password=aera_config.PGVECTOR_PASSWORD or "",
                database=aera_config.PGVECTOR_DATABASE or "postgres",
                min_connection=aera_config.PGVECTOR_MIN_CONNECTION,
                max_connection=aera_config.PGVECTOR_MAX_CONNECTION,
            ),
        )
