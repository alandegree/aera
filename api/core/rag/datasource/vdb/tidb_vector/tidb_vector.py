    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=aera_config.TIDB_VECTOR_HOST or "",
                port=aera_config.TIDB_VECTOR_PORT or 0,
                user=aera_config.TIDB_VECTOR_USER or "",
                password=aera_config.TIDB_VECTOR_PASSWORD or "",
                database=aera_config.TIDB_VECTOR_DATABASE or "",
                program_name=aera_config.APPLICATION_NAME,
            ),
        )
