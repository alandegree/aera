...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=aera_config.CHROMA_HOST or "",
                port=aera_config.CHROMA_PORT,
                tenant=aera_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=aera_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=aera_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=aera_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
