...
class DatasetRetrieval:
    ...
    def retrieve(
        ...
        aera_documents = [item for item in all_documents if item.provider == "aera"]
        ...
        # deal with aera documents
        if aera_documents:
            records = RetrievalService.format_retrieval_documents(aera_documents)
            if records:
    ...
    def _on_retrieval_end(
        ...
        aera_documents = [document for document in documents if document.provider == "aera"]
        for document in aera_documents:
            if document.metadata is not None:
