...
def _extract_text_from_doc(file_content: bytes) -> str:
    ...
    if not (aera_config.UNSTRUCTURED_API_URL and aera_config.UNSTRUCTURED_API_KEY):
        ...
        with tempfile.NamedTemporaryFile(suffix=".doc", delete=False) as temp_file:
            ...
            with open(temp_file.name, "rb") as file:
                elements = partition_via_api(
                    ...
                    api_url=aera_config.UNSTRUCTURED_API_URL,
                    api_key=aera_config.UNSTRUCTURED_API_KEY,
                )
...
def _extract_text_from_ppt(file_content: bytes) -> str:
    ...
    try:
        if aera_config.UNSTRUCTURED_API_URL and aera_config.UNSTRUCTURED_API_KEY:
