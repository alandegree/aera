...
HTTP_REQUEST_DEFAULT_TIMEOUT = HttpRequestNodeTimeout(
    connect=aera_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
    read=aera_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
    write=aera_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
)
            ...
            "config": {
                ...
                "timeout": {
                    **HTTP_REQUEST_DEFAULT_TIMEOUT.model_dump(),
                    "max_connect_timeout": aera_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
                    "max_read_timeout": aera_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
                    "max_write_timeout": aera_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
                },
            },
            "retry_config": {
                "max_retries": aera_config.SSRF_DEFAULT_MAX_RETRIES,
