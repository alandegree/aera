...
class HttpRequestNodeTimeout(BaseModel):
    connect: int = aera_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT
    read: int = aera_config.HTTP_REQUEST_MAX_READ_TIMEOUT
    write: int = aera_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT
