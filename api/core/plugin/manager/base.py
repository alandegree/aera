...
plugin_daemon_inner_api_baseurl = aera_config.PLUGIN_DAEMON_URL
plugin_daemon_inner_api_key = aera_config.PLUGIN_DAEMON_KEY
    ...
    def _request_with_plugin_daemon_response_stream(
        ...
        for line in self._stream_request(method, path, params, headers, data, files):
            ...
            try:
                ...
                # TODO moaera this when line_data has code and message
