...
from core.callback_handler.agent_tool_callback_handler import AeraAgentCallbackHandler
from core.callback_handler.workflow_tool_callback_handler import AeraWorkflowCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: AeraAgentCallbackHandler,
    ...
    def generic_invoke(
        ...
        user_id: str,
        workflow_tool_callback: AeraWorkflowCallbackHandler,
