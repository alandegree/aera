...
def test_run():
    ...
    pool.add(["pe", "list_output"], ["aera-1", "aera-2"])
    ...
    def tt_generator(self):
        return NodeRunResult(
            ...
            inputs={"iterator_selector": "aera"},
            outputs={"output": "aera 123"},
        )
    ...
    with patch.object(TemplateTransformNode, "_run", new=tt_generator):
        ...
        for item in result:
            ...
            if isinstance(item, RunCompletedEvent):
                ...
                assert item.run_result.outputs == {"output": ["aera 123", "aera 123"]}
