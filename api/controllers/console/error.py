...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "Aera has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "Aera has not been initialized and installed yet. "
