    ...
    def get(self):
        ...
        try:
            return {
                ...
                "host": aera_config.PLUGIN_REMOTE_INSTALL_HOST,
                "port": aera_config.PLUGIN_REMOTE_INSTALL_PORT,
            }
...
class PluginIconApi(Resource):
    ...
    def get(self):
        ...
        icon_cache_max_age = aera_config.TOOL_ICON_CACHE_MAX_AGE
...
class PluginUploadFromPkgApi(Resource):
    ...
    def post(self):
        ...
        # check file size
        if file.content_length > aera_config.PLUGIN_MAX_PACKAGE_SIZE:
...
class PluginUploadFromBundleApi(Resource):
    ...
    def post(self):
        ...
        # check file size
        if file.content_length > aera_config.PLUGIN_MAX_BUNDLE_SIZE:
            raise ValueError("File size exceeds the maximum allowed size")
