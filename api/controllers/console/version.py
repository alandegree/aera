...
class VersionApi(Resource):
    def get(self):
        ...
        check_update_url = aera_config.CHECK_UPDATE_URL

        result = {
            "version": aera_config.CURRENT_VERSION,
            "release_date": "",
            "release_notes": "",
            "can_auto_update": False,
            "features": {
                "can_replace_logo": aera_config.CAN_REPLACE_LOGO,
                "model_load_balancing_enabled": aera_config.MODEL_LB_ENABLED,
            },
        }
