...
def send_deletion_success_task(to):
    ...
    try:
        ...
        mail.send(to=to, subject="Your Aera.ac Account Has Been Successfully Deleted", html=html_content)
...
def send_account_deletion_verification_code(to, code):
    ...
    try:
        ...
        mail.send(to=to, subject="Aera.ac Account Deletion and Verification", html=html_content)
