...
export declare class AeraClient {
...
export declare class CompletionClient extends AeraClient {
...
export declare class ChatClient extends AeraClient {
  createChatMessage(
    inputs: any,
    query: string,
    user: User,
...
export declare class WorkflowClient extends AeraClient {
