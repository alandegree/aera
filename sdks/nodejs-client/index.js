...
export const BASE_URL = "https://api.aera.ac/v1";
...
export class CompletionClient extends AeraClient {
...
export class ChatClient extends AeraClient {
  createChatMessage(
    inputs,
    query,
    user,
...
export class WorkflowClient extends AeraClient {
