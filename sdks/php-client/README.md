...
This is the PHP SDK for the Aera API, which allows you to easily integrate Aera into your PHP applications.
...
use YourVendorName\AeraPHP\AeraClient;
use YourVendorName\AeraPHP\CompletionClient;
use YourVendorName\AeraPHP\ChatClient;

$apiKey = 'your-api-key-here';

$aeraClient = new AeraClient($apiKey);
...
$response = $aeraClient->file_upload("user_id", $fileForUpload);
$result = json_decode($response->getBody(), true);
echo 'upload_file_id: ' . $result['id'];

// Fetch application parameters
$response = $aeraClient->get_application_parameters("user_id");

// Provide feedback for a message
$response = $aeraClient->message_feedback($message_id, $rating, "user_id");
...
Replace 'your-api-key-here' with your actual Aera API key.
