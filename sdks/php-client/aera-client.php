...
class AeraClient {
    ...
    public function __construct($api_key, $base_url = null) {
        ...
        $this->base_url = $base_url ?? "https://api.aera.ac/v1/";
...
class CompletionClient extends AeraClient {
...
class ChatClient extends AeraClient {
...
class WorkflowClient extends AeraClient{
