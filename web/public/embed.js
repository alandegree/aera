 ...
 * the aeraChatbotConfig should be defined in the html file before this script is included
 * the aeraChatbotConfig should contain the token of the chatbot
...
(function () {
  ...
  const configKey = "aeraChatbotConfig";
  const buttonId = "aera-chatbot-bubble-button";
  const iframeId = "aera-chatbot-bubble-window";
  ...
  async function embedChatbot() {
    ...
    const baseUrl =
      config.baseUrl || `https://${config.isDev ? "dev." : ""}aera.ac`;
    ...
    function createIframe() {
      ...
      iframe.title = "aera chatbot bubble window";
      iframe.id = iframeId;
