            ...
            <div className='flex justify-between items-end'>
              <div>
                <div className='title-xl-semi-bold text-text-primary'>
                  {collection.label[getLanguage(locale)]?.replace(/aera/gi, match =>
                    match === 'aera' ? 'aera'
                      : match === 'Aera' ? 'Aera'
                        : match === 'AERA' ? 'AERA'
                          : 'aera')}
                </div>
                <div className='system-xs-regular text-text-tertiary'>{collection.description[getLanguage(locale)]?.replace(/aera/gi, match =>
                  match === 'aera' ? 'aera'
                    : match === 'Aera' ? 'Aera'
                      : match === 'AERA' ? 'AERA'
                        : 'aera')}</div>
