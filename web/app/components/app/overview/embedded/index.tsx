...
<style>
  #aera-chatbot-bubble-button {
    background-color: ${primaryColor} !important;
  }
  #aera-chatbot-bubble-window {
...
const Embedded = ({ siteInfo, isShow, onClose, appBaseUrl, accessToken, className }: Props) => {
  ...
  const navigateToChromeUrl = () => {
    window.open('https://chrome.google.com/webstore/detail/aera-chatbot/ceehdapohffmjmkdcifjofadiaoeggaf', '_blank')
  }
