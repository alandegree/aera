...
function CreateApp({ onClose, onSuccess, onCreateFromTemplate }: CreateAppProps) {
  ...
  return <>
    <div className='flex justify-center h-full overflow-y-auto overflow-x-hidden'>
      <div className='flex-1 shrink-0 flex flex-col-reverse justify-center'>
        <div className='px-10 max-w-[660px] mx-auto'>
          ...
          <div className='flex space-x-3 items-center max-w-[660px]'>
            ...
            <div>
              ...
              <div className='flex flex-row gap-2'>
                <AppTypeCard
                  ...
                  icon={<div className='w-6 h-6 hidden bg-components-icon-bg-blue-solid rounded-md items-center justify-center'>
                ...
                <AppTypeCard
                  ...
                  icon={<div className='w-6 h-6 bg-components-icon-bg-violet-solid rounded-md hidden items-center justify-center'>
                ...
                <AppTypeCard
                  ...
                  icon={<div className='w-6 h-6 bg-components-icon-bg-teal-solid rounded-md hidden items-center justify-center'>
            ...
            <div>
              ...
              <div className='flex flex-row gap-2'>
                <AppTypeCard
                  ...
                  icon={<div className='w-6 h-6 bg-components-icon-bg-blue-light-solid rounded-md hidden items-center justify-center'>
                ...
                <AppTypeCard
                  ...
                  icon={<div className='w-6 h-6 bg-components-icon-bg-indigo-solid rounded-md hidden items-center justify-center'>
...
function AppPreview({ mode }: { mode: AppMode }) {
  ...
  const modeToPreviewInfoMap = {
    'chat': {
      ...
      link: 'https://docs.aera.ac/guides/application-orchestrate/conversation-application?fallback=true',
    },
    'advanced-chat': {
      title: t('app.types.advanced'),
      description: t('app.newApp.advancedUserDescription'),
      link: 'https://docs.aera.ac/guides/workflow',
    },
    'agent-chat': {
      title: t('app.types.agent'),
      description: t('app.newApp.agentUserDescription'),
      link: 'https://docs.aera.ac/guides/application-orchestrate/agent',
    },
    'completion': {
      title: t('app.newApp.completeApp'),
