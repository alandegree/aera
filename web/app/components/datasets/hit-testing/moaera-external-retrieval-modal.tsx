...
type MoaeraExternalRetrievalModalProps = {
  onClose: () => void
...
const MoaeraExternalRetrievalModal: React.FC<MoaeraExternalRetrievalModalProps> = ({
  onClose,
  onSave,
  initialTopK,
...
export default MoaeraExternalRetrievalModal
