...
export class Theme {
  ...
  public primaryColor = '#a5a4fa' // Updated to light purple
  public backgroundHeaderColorStyle = 'backgroundImage: linear-gradient(to right, #7584d6, #80e5ff)' // Updated gradient
  ...
  public backgroundButtonDefaultColorStyle = 'backgroundColor: #a5a4fa' // Updated to light purple
  public roundedBackgroundColorStyle = 'backgroundColor: rgb(223, 225, 245)' // Updated to very light purple
  public chatBubbleColorStyle = 'backgroundColor: rgb(223, 225, 245)' // Updated to very light purple
  public chatBubbleColor = 'rgb(223, 225, 245)' // Updated to very light purple
  ...
  private configCustomColor() {
    if (this.chatColorTheme !== null && this.chatColorTheme !== '') {
      this.primaryColor = this.chatColorTheme ?? '#a5a4fa' // Updated default color
  ...
  private configInvertedColor() {
    if (this.chatColorThemeInverted) {
      ...
      this.headerBorderBottomStyle = 'borderBottom: 1px solid #ffffff' // Updated to very light purple
