const translation = {
  ...
  welcome: 'Bine ai venit la Aera, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Aera Community Edition, citește',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Aera și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Aera. Contactați administratorul pentru a continua să utilizați Aera.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Aera Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Aera.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Aera Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Aera.',
}
