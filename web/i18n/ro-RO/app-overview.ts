const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Aera cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Aera.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Aera Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
