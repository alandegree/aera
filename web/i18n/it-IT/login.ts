const translation = {
  ...
  welcome: 'Benvenuto su Aera, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Aera Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Aera',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Aera',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Aera e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Aera. Contatta il tuo amministratore per continuare a utilizzare Aera.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Aera Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Aera.',
  licenseInactiveTip: 'La licenza Aera Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Aera.',
