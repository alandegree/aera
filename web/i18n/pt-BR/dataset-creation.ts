const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: 'https://docs.aera.ac/guides/knowledge-base/sync-from-website',
  ...
  otherDataSource: {
    ...
    description: 'Atualmente, a base de conhecimento da Aera possui apenas fontes de dados limitadas. Contribuir com uma fonte de dados para a base de conhecimento Aera é uma maneira fantástica de ajudar a aumentar a flexibilidade e o poder da plataforma para todos os usuários. Nosso guia de contribuição facilita o início. Clique no link abaixo para saber mais.',
