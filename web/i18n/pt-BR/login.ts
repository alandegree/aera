const translation = {
  ...
  welcome: 'Bem-vindo ao Aera, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Aera, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Aera',
  invalid: 'O link expirou',
  explore: 'Explorar o Aera',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Aera e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Aera Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Aera.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Aera. Entre em contato com o administrador para continuar usando o Aera.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Aera Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Aera.',
}
