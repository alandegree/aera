const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Aera ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Aera و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
