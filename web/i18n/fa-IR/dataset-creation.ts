const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: '<a href="https://docs.aera.ac/guides/knowledge-base/sync-from-website">https://docs.aera.ac/guides/knowledge-base/sync-from-website</a>',
      options: 'گزینهها',
  ...
  otherDataSource: {
    ...
    description: 'در حال حاضر، پایگاه دانش Aera فقط منابع داده محدودی دارد. کمک به یک منبع داده به پایگاه دانش Aera راهی فوق العاده برای کمک به افزایش انعطاف پذیری و قدرت پلتفرم برای همه کاربران است. راهنمای مشارکت ما شروع کار را آسان می کند. لطفا برای کسب اطلاعات بیشتر روی لینک زیر کلیک کنید.',
