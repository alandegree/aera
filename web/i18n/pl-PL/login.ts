const translation = {
  ...
  welcome: 'Witaj w Aera, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Aera, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Aera',
  invalid: 'Link wygasł',
  explore: 'Odkryj Aera',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Aera, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Aera Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Aera.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Aera. Skontaktuj się z administratorem, aby kontynuować korzystanie z Aera.',
  licenseInactiveTip: 'Licencja Aera Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Aera.',
}
