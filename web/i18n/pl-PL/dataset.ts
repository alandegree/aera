const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Aera ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Aera i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
