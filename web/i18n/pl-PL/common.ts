const translation = {
  ...
  account: {
    ...
    aeraAccount: 'Konto Aera',
    aeraAccountTip: 'Twoje konto Aera i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Aera, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Aera pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Aera.',
  ...
  about: {
    ...
    nowAvailable: 'Aera {{version}} jest teraz dostępny.',
    latestAvailable: 'Aera {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
