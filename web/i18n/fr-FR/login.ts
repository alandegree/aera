const translation = {
  ...
  welcome: 'Bienvenue sur Aera, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Aera Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Aera',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Aera',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Aera et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Aera Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Aera.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Aera. Veuillez contacter votre administrateur pour continuer à utiliser Aera.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Aera Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Aera.',
