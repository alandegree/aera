const translation = {
  ...
  account: {
    ...
    aeraAccount: 'Compte Aera',
    aeraAccountTip: 'Votre compte Aera et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à Aera pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par Aera vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de Aera.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.aera.ac/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'Aera {{version}} est maintenant disponible.',
    latestAvailable: 'Aera {{version}} est la dernière version disponible.',
  },
  appMenus: {
