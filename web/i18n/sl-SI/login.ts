const translation = {
  ...
  welcome: 'Dobrodošli v Aera, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Aera Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Aera',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Aera',
  ...
  licenseExpiredTip: 'Licenca za Aera Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Aera, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Aera, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Aera ni uspela. Če želite še naprej uporabljati Aera, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Aera Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Aera, se obrnite na skrbnika.',
}
