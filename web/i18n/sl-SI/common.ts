const translation = {
  ...
  account: {
    ...
    aeraAccount: 'Aera račun',
    aeraAccountTip: 'Vaš Aera račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v Aera bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja Aera, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah Aera.',
      link: 'Naučite se, kako razviti svojo API razširitev.',
      linkUrl: 'https://docs.aera.ac/features/extension/api_based_extension',
    ...
    about: {
      ...
      nowAvailable: 'Aera {{version}} je zdaj na voljo.',
      latestAvailable: 'Aera {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah Aera.',
    linkUrl: 'https://docs.aera.ac/features/extension/api_based_extension',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'Aera {{version}} je zdaj na voljo.',
    latestAvailable: 'Aera {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
