const translation = {
  ...
  welcome: '👋 Welcome to Aera, please log in to continue.',
  email: 'Email address',
  ...
  walletAuthError: 'An error occurred during wallet authentication',
  ...
  license: {
    tip: 'Before starting Aera Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Aera',
  invalid: 'The link has expired',
  explore: 'Explore Aera',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Aera and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Aera Enterprise license for your workspace has expired. Please contact your administrator to continue using Aera.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Aera license server. Please contact your administrator to continue using Aera.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Aera Enterprise license for your workspace is inactive. Please contact your administrator to continue using Aera.',
}
