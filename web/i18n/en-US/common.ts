const translation = {
  ...
  account: {
    ...
    aeraAccount: 'Aera account',
    aeraAccountTip: 'Your Aera account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Aera to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Aera allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Aera\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Aera {{version}} is now available.',
    latestAvailable: 'Aera {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
