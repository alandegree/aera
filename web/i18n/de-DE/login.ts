const translation = {
  ...
  welcome: 'Willkommen bei Aera, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Aera Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Aera beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Aera erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Aera angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Aera-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Aera weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Aera Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Aera weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Aera Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Aera weiterhin zu verwenden.',
