const translation = {
  ...
  intro1: 'Bilgi, Aera uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Aera dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
