const translation = {
  ...
  welcome: 'Aera\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Aera Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Aera\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Aera Enterprise lisansının süresi doldu. Aera\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Aera lisans sunucusuna bağlanılamadı. Aera\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Aera Enterprise lisansı etkin değil. Aera\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
